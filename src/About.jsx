...
const About = () => {
  return (
    <div
      id="About"
      className="h-screen w-full snap-center flex max-md:flex-col items-center justify-center transition-all ease-in scroll-smooth p-16 max-md:p-5"
    >
      {/* <HeadingText title={"ABOUT ME"} /> */}

      <div className="p-5 w-[50%] max-md:w-full">
        <motion.div initial={{y:100}} whileInView={{y:0}} className="text-8xl max-md:text-4xl font-bold z-0">Hey there! , I am <strong className="text-transparent" style={{WebkitTextStroke:"0.1px black"}}>Venkatesh</strong>.</motion.div>
      ...
      <div className="p-5 w-[50%] max-md:w-full h-full">
